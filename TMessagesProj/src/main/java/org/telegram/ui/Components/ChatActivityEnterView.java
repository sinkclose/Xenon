...
//                    list.add(2);
    ...
    private void sendPhoto(String mime, Uri uri, boolean notify, int scheduleDate) {
        ...
        if (mime.equalsIgnoreCase("image/gif")) {
            SendMessagesHelper.prepareSendingDocument(accountInstance, null, null, uri, null, "image/gif", dialog_id, replyingMessageObject, getThreadMessage(), null, replyingQuote, null, notify, 0, mime, parentFragment != null ? parentFragment.getMessageChatSendParams() : null, false);
        } else {
            SendMessagesHelper.prepareSendingPhoto(accountInstance, null, uri, dialog_id, replyingMessageObject, getThreadMessage(), replyingQuote, null, null, null, mime, 0, null, notify, 0, parentFragment == null ? 0 : parentFragment.getChatMode(), parentFragment != null ? parentFragment.getMessageChatSendParams() : null);
        }
        if (delegate != null) {
...
//        }
    ...
    public void updateSendAsButton(boolean forceHide, boolean animated) {
        ...
        final boolean isVisible = !forceHide && !DialogObject.isUserDialog(dialog_id) && defPeer != null
