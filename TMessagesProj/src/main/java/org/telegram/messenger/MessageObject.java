...
//        }
        if (message instanceof TLRPC.TL_message_secret) {
            ...
            return true && (getMedia(message) instanceof TLRPC.TL_messageMediaPhoto || getMedia(message) instanceof TLRPC.TL_messageMediaDocument) && getMedia(message).ttl_seconds != 0;
        }
    }
    ...
    public boolean needDrawBluredPreview() {
        ...
        if (hasExtendedMediaPreview()) {
            ...
            return true && (getMedia(messageOwner) != null && getMedia(messageOwner).ttl_seconds != 0) && (getMedia(messageOwner) instanceof TLRPC.TL_messageMediaPhoto || getMedia(messageOwner) instanceof TLRPC.TL_messageMediaDocument);
        }
        return false;
    }
