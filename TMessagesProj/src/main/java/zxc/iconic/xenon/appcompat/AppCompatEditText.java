...
package zxc.iconic.xenon.appcompat;

import static zxc.iconic.xenon.appcompat.AppCompatReceiveContentHelper.maybeHandleDragEventViaPerformReceiveContent;
import static zxc.iconic.xenon.appcompat.AppCompatReceiveContentHelper.maybeHandleMenuActionViaPerformReceiveContent;
...
public class AppCompatEditText extends EditText implements OnReceiveContentViewBehavior {
    ...
    public AppCompatEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
